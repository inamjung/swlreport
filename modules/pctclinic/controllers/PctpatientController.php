...
use app\modules\pctclinic\models\PctpatientSearch;
 ...
 //    +++++++อับโหลดรูป++++++++++
    ...
    private function getInitialPreview($ref) {
            ...
            foreach ($datas as $key => $value) {
                ...
                array_push($initialPreviewConfig, [
                    ...
                    'width'  => '120px',
                    'url'    => Url::to(['/pctclinic/pctpatient/deletefile-ajax']),
                    'key'    => $value->upload_id
                ]);
            }
  ...
  //    !+++++++อับโหลดรูป++++++++++  
    ...
    public function actionReport3(){
         ...
         public function actionIndivhistoryhn($hn = null){
        
        $sql = "SELECT * FROM pctpatient
                WHERE hn='$hn'
                ORDER BY hn desc";        
