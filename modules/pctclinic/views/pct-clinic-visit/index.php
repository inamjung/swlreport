            ...
            [
                ...
                'buttons'=>[
                    ...
                    'update'=>function($url,$model,$key){
                        return Html::a('<i class="glyphicon glyphicon-pencil"></i>',['pctclinic/pct-clinic-visit/updatehos','id'=>$model->vn],                                  
                            [                            
        ...
        function init_click_handlers(){
            ...
            $(".activity-view-link").click(function(e) {
                    ...
                    var $td = $(this).closest("tr").children("td");
                     var sr = $td.eq(1).text();
                    $.get(
                        "?r=pctclinic/pct-clinic-visit/view",
                        {
                            hn: sr
                        },
                        function (data)
            ...
            $(".activity-update-link").click(function(e) {
                    var fID = $(this).closest("tr").data("key");
                    $.get(
                        "?r=pctclinic/pct-clinic-visit/updatehos",
                        {
                           id: fID
                        },
                        function (data)
