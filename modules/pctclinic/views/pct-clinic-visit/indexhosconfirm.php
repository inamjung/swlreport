...
?>
<div class="pctclinicvisit-index">

    <div class="alert alert-warning" role="alert"><h3><?= Html::encode($this->title) ?></h3>
        รอเข้าระบบแล้ว - ผู้ป่วยคลินิกเรื้อรังที่มีค่า CVD_Risk ระดับ 2 ขึ้นไป</div>
...
//                    }, 
                    'update'=>function($url,$model,$key){
                        return Html::a('<i class="glyphicon glyphicon-pencil"></i> รับเคส',['pctclinic/pct-clinic-visit/update','id'=>$model->vn],                                  
                            [                            
...
<?php
        ...
        function init_click_handlers(){
            ...
            $(".activity-update-link").click(function(e) {
                    var fID = $(this).closest("tr").data("key");
                    $.get(
                        "?r=pctclinic/pct-clinic-visit/update",
                        {
                           id: fID
                        },
                        function (data)
