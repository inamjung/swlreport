...
$this->title = 'ติดตามผลการเยี่ยม กลุ่มเสี่ยงที่ส่งผู้ป่วยให้ รพ.สต';
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="pct-risk-indexview">
    <div class="alert alert-info" role="alert"><h3><?= Html::encode($this->title) ?></h3>
        กลุ่มเสี่ยงที่ รพ.สต.ลงเยี่ยมแล้ว </div>
...
//                    }, 
                    'update'=>function($url,$model,$key){
                        return Html::a('<i class="glyphicon glyphicon-search"> ข้อมูลเคส</i>',['view','id'=>$model->id],['class'=>'btn btn-success']);
                    },
//                    'update'=>function($url,$model,$key){
//                        return Html::a('<i class="glyphicon glyphicon-pencil"> บันทึกเยี่ยม</i>',['pctclinic/pct-risk/view','id'=>$model->id],                                  
//                            [                            
