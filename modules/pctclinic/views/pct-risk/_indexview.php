...
<div class="pct-risk-updateview">
    ...
    <div class="row"> 
        ...
        <div class="col-xs-3 col-sm-3 col-md-3">
            <?= $form->field($model, 'latitude')->textInput(['readonly'=>'true','maxlength' => true]) ?>
        </div>
       
        <div class="col-xs-3 col-sm-3 col-md-3">
            <?= $form->field($model, 'longitude')->textInput(['readonly'=>'true','maxlength' => true]) ?>
        </div>
    </div>
