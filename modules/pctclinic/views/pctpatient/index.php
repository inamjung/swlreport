...
//             ],
            ...
            [
             ...
             [
                  ...
                  'value'=>'address.name',
                  'filter'=>ArrayHelper::map(app\modules\pctclinic\models\Pctaddress::find()->orderBy('tmbpart')->asArray()->all(), 'name', 'name'),  
                    'vAlign'=>'middle',                    
                    'filterType'=>GridView::FILTER_SELECT2,           
                    'filterWidgetOptions'=>[
                    'pluginOptions'=>['allowClear'=>true],
              ...
              [
                  'attribute'=>'main_pdx',
                  'value'=>'main_pdx',
                  'filter'=>ArrayHelper::map(app\modules\pctclinic\models\Pctdisease::find()->orderBy('code')->asArray()->all(), 'code', 'code'),  
                    'vAlign'=>'middle',                    
                    'filterType'=>GridView::FILTER_SELECT2,           
                    'filterWidgetOptions'=>[
                    'pluginOptions'=>['allowClear'=>true],
...
//              ],    
             ...
             [
               ...
               [
                ...
                'filter' => Pctpatient::$ptypes,
                'value' => function($data) {
                    return Pctpatient::$ptypes[$data->ptype];
                }
             ], 
             [
                'attribute' => 'pstatus',
                'contentOptions' => ['class'=>'text-center','style'=>'width: 90px;'],
                'filter' => Pctpatient::$pstatuses,
                'value' => function($data) {
                    return Pctpatient::$pstatuses[$data->pstatus];
        ...
        function init_click_handlers(){
            ...
            $(".activity-view-link").click(function(e) {
                    ...
                    var $td = $(this).closest("tr").children("td");
                     var sr = $td.eq(1).text();
                    $.get(
                        "?r=pctclinic/pctpatient/indivhistoryhn",
                        {
                            hn: sr
                        },
                        function (data)
