 ...
 * @property integer $criticalpriority
 ...
 * @property integer $maxunitperdose
 * @property integer $packqty
 * @property integer $reorderqty
 ...
 * @property integer $pharmacology_group1
 * @property integer $pharmacology_group2
 * @property integer $pharmacology_group3
 ...
 * @property integer $habit_forming_type
 ...
 * @property integer $ipd_default_pay
 ...
 * @property integer $child_notify_min_age
 * @property integer $child_notify_max_age
 * @property string $continuous
 * @property string $substitute_icode
 * @property string $trade_name
 * @property string $use_right_allow
 * @property integer $medication_machine_id
 * @property integer $ipd_medication_machine_id
 * @property string $check_remed_qty
 * @property string $addict
 * @property integer $addict_type_id
 * @property integer $medication_machine_opd_no
 * @property integer $medication_machine_ipd_no
 ...
 * @property integer $sks_product_category_id
 * @property integer $sks_clain_control_type_id
 ...
 * @property integer $check_druginteraction_history_day
 * @property integer $nhso_adp_type_id
 * @property string $nhso_adp_code
 * @property integer $sks_claim_control_type_id
 ...
 * @property integer $drug_control_type_id
 ...
 * @property integer $drugitems_due_type_id
 * @property integer $drugeval_head_id
 ...
 */
class Hosdrugitems extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
