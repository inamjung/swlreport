 ...
 */
class Hospatient extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function getName()
{
   return $this->pname .''.$this->fname. ' ' . $this->lname;
    ...
    public function getPctaddress(){
        return $this->hasOne(Pctaddress::className(), ['tmbpart'=>'tmbpart']);
    }
    public function getPctpatient(){
        return $this->hasMany(Pctpatient::className(), ['hn'=>'hn']);
    }
}
