   ...
   public function behaviors()
    {
        return [
            ...
            'access'=>[
                ...
                'only'=> ['index','ht0','ht1','htall','htckd'],
                'ruleConfig'=>[
       ...
       $connection = Yii::$app->db2;
        $data = $connection->createCommand('
           SELECT cc.`name` as clinicname
            ...
            WHERE c.clinic="002" and clinic_member_status_id in ("3","11")
                        ')->queryAll();
