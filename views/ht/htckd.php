<?php
$this->title = ' รายชื่อผู้ป่วยในทะเบียนคลินิกโรคความดันโลหิตสูงที่มีโรคไตวายเรื้อรังร่วม(HT+CKD)_มีผลแลป แยกตำบล';
$this->params['breadcrumbs'][] = ['label' => 'รายงานNCD', 'url' => ['ncd/index']];
$this->params['breadcrumbs'][] = ['label' => 'รายงาน HT', 'url' => ['ht/index']];
...
echo \kartik\grid\GridView::widget([
    ...
    'floatHeader' => FALSE,
    'panel' => [
        'heading'=>'รายชื่อผู้ป่วยในทะเบียนคลินิกโรคความดันโลหิตสูงที่มีโรคไตวายเรื้อรังร่วม(HT+CKD)_มีผลแลป แยกตำบล',
        'before' => '',
