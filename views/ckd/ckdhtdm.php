<?php
$this->title = ' รายชื่อผู้ป่วยในทะเบียนคลินิกโรคไตวายเรื้อรังที่มีโรคความดันโลหิตสูงและเบาหวานร่วม_(CKD+HT+DM)มีผลแลป (แยกตำบล)';
...
echo \kartik\grid\GridView::widget([
    ...
    'floatHeader' => FALSE,
    'panel' => [
        'heading'=>'รายชื่อผู้ป่วยในทะเบียนคลินิกโรคไตวายเรื้อรังที่มีโรคความดันโลหิตสูงและเบาหวานร่วม_(CKD+HT+DM)มีผลแลป (แยกตำบล)',
        'before' => '',
